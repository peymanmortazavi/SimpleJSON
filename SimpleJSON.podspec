...
Pod::Spec.new do |s|
  s.name             = 'SimpleJSON'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SimpleJSON.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/SimpleJSON'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Peyman Mortazavi' => 'pey.mortazavi@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/SimpleJSON.git', :tag => s.version.to_s }
